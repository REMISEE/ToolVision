...
# 8-GPU eval for merged HF export of mutv1_128bs_0618/global_step_60 on the 9-benchmark set.
...
export JOB_NAME_PREFIX="${JOB_NAME_PREFIX:-cv-mutv1-128bs-s60-merged-allbench-8gpu}"
export EXP_PREFIX="${EXP_PREFIX:-mutv1_128bs_s60_merged_allbench_8gpu}"
