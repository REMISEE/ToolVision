...
STEP_JUDGE_AGGREGATION="${STEP_JUDGE_AGGREGATION:-committee_group_mean}"
...
append_env STEP_REWARD_USE_MUT_WEIGHT "${STEP_REWARD_USE_MUT_WEIGHT}"
...
append_env STEP_JUDGE_NUM_JUDGMENTS "${STEP_JUDGE_NUM_JUDGMENTS}"
append_env STEP_JUDGE_AGGREGATION "${STEP_JUDGE_AGGREGATION}"
append_env STEP_JUDGE_PROMPT_MODE "${STEP_JUDGE_PROMPT_MODE}"
...
append_env STEP_JUDGE_MAX_CONTEXT_CHARS "${STEP_JUDGE_MAX_CONTEXT_CHARS}"
