...
COMMITTEE_API1_BASE_URL="${COMMITTEE_API1_BASE_URL:-https://dashscope.aliyuncs.com/compatible-mode/v1}"
...
COMMITTEE_API2_NAME="${COMMITTEE_API2_NAME:-gemini25_flash_147ai}"
COMMITTEE_API2_BASE_URL="${COMMITTEE_API2_BASE_URL:-https://147ai.com/v1}"
COMMITTEE_API2_MODEL="${COMMITTEE_API2_MODEL:-gemini-2.5-flash-nothinking}"
COMMITTEE_API2_API_KEY="${COMMITTEE_API2_API_KEY:-${OFFLINE_SFT_147AI_API_KEY:-}}"
COMMITTEE_API2_REQUEST_BODY="${COMMITTEE_API2_REQUEST_BODY:-{\"max_tokens\":256}}"
