...
append_env COMMITTEE_REQUIRE_ALL "${COMMITTEE_REQUIRE_ALL}"
append_env COMMITTEE_MIN_SUCCESSES "${COMMITTEE_MIN_SUCCESSES}"
append_env COMMITTEE_MIN_SUCCESS_GROUPS "${COMMITTEE_MIN_SUCCESS_GROUPS}"
append_env COMMITTEE_REQUIRED_GROUPS "${COMMITTEE_REQUIRED_GROUPS}"
append_env COMMITTEE_REQUIRED_ANY_GROUPS "${COMMITTEE_REQUIRED_ANY_GROUPS}"
append_env COMMITTEE_MAX_INFLIGHT_REQUESTS "${COMMITTEE_MAX_INFLIGHT_REQUESTS}"
append_env COMMITTEE_REQUEST_QUEUE_SIZE "${COMMITTEE_REQUEST_QUEUE_SIZE}"
append_env COMMITTEE_LOCAL_MAX_CONCURRENCY "${COMMITTEE_LOCAL_MAX_CONCURRENCY}"
append_env COMMITTEE_32B_MAX_CONCURRENCY "${COMMITTEE_32B_MAX_CONCURRENCY}"
append_env COMMITTEE_API_MAX_CONCURRENCY "${COMMITTEE_API_MAX_CONCURRENCY}"
append_env COMMITTEE_INCLUDE_8B_TEST "${COMMITTEE_INCLUDE_8B_TEST}"
append_env JUDGE_START_8B_TEST "${JUDGE_START_8B_TEST}"
append_env COMMITTEE_API1_NAME "${COMMITTEE_API1_NAME}"
append_env COMMITTEE_API1_ENABLED "${COMMITTEE_API1_ENABLED}"
...
append_env COMMITTEE_API2_ENABLED "${COMMITTEE_API2_ENABLED}"
...
append_env JUDGE_PARALLEL_START "${JUDGE_PARALLEL_START}"
append_env JUDGE_VLLM_EXTRA_ARGS_COMMON "${JUDGE_VLLM_EXTRA_ARGS_COMMON}"
append_env JUDGE_VLLM_EXTRA_ARGS_SMALL "${JUDGE_VLLM_EXTRA_ARGS_SMALL}"
append_env JUDGE_VLLM_EXTRA_ARGS_32B "${JUDGE_VLLM_EXTRA_ARGS_32B}"
if [[ -n "${VLLM_USE_V1}" ]]; then
  append_env VLLM_USE_V1 "${VLLM_USE_V1}"
fi
...
echo "COMMITTEE_REQUIRE_ALL=${COMMITTEE_REQUIRE_ALL}"
echo "COMMITTEE_MIN_SUCCESSES=${COMMITTEE_MIN_SUCCESSES}"
echo "COMMITTEE_MIN_SUCCESS_GROUPS=${COMMITTEE_MIN_SUCCESS_GROUPS}"
echo "COMMITTEE_REQUIRED_GROUPS=${COMMITTEE_REQUIRED_GROUPS:-<none>}"
echo "COMMITTEE_REQUIRED_ANY_GROUPS=${COMMITTEE_REQUIRED_ANY_GROUPS:-<none>}"
echo "COMMITTEE_MAX_INFLIGHT_REQUESTS=${COMMITTEE_MAX_INFLIGHT_REQUESTS}"
echo "COMMITTEE_REQUEST_QUEUE_SIZE=${COMMITTEE_REQUEST_QUEUE_SIZE}"
echo "COMMITTEE_LOCAL_MAX_CONCURRENCY=${COMMITTEE_LOCAL_MAX_CONCURRENCY}"
echo "COMMITTEE_32B_MAX_CONCURRENCY=${COMMITTEE_32B_MAX_CONCURRENCY}"
echo "COMMITTEE_API_MAX_CONCURRENCY=${COMMITTEE_API_MAX_CONCURRENCY}"
echo "COMMITTEE_INCLUDE_8B_TEST=${COMMITTEE_INCLUDE_8B_TEST}"
echo "JUDGE_START_8B_TEST=${JUDGE_START_8B_TEST}"
echo "COMMITTEE_API1_ENABLED=${COMMITTEE_API1_ENABLED}"
echo "COMMITTEE_API2_ENABLED=${COMMITTEE_API2_ENABLED}"
echo "JUDGE_PARALLEL_START=${JUDGE_PARALLEL_START}"
echo "JUDGE_VLLM_EXTRA_ARGS_COMMON=${JUDGE_VLLM_EXTRA_ARGS_COMMON}"
echo "JUDGE_VLLM_EXTRA_ARGS_SMALL=${JUDGE_VLLM_EXTRA_ARGS_SMALL}"
echo "JUDGE_VLLM_EXTRA_ARGS_32B=${JUDGE_VLLM_EXTRA_ARGS_32B}"
echo "Gateway:"
