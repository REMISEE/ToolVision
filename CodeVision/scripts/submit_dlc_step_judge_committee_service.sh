...
COMMITTEE_REQUIRE_ALL="${COMMITTEE_REQUIRE_ALL:-1}"
COMMITTEE_MAX_INFLIGHT_REQUESTS="${COMMITTEE_MAX_INFLIGHT_REQUESTS:-4}"
COMMITTEE_LOCAL_MAX_CONCURRENCY="${COMMITTEE_LOCAL_MAX_CONCURRENCY:-1}"
COMMITTEE_32B_MAX_CONCURRENCY="${COMMITTEE_32B_MAX_CONCURRENCY:-1}"
COMMITTEE_API_MAX_CONCURRENCY="${COMMITTEE_API_MAX_CONCURRENCY:-1}"
...
JUDGE_VLLM_EXTRA_ARGS_SMALL="${JUDGE_VLLM_EXTRA_ARGS_SMALL:---max-num-seqs 8 --max-num-batched-tokens 65536}"
JUDGE_VLLM_EXTRA_ARGS_32B="${JUDGE_VLLM_EXTRA_ARGS_32B:---max-num-seqs 4 --max-num-batched-tokens 65536}"
