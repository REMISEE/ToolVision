...
JUDGE_VLLM_EXTRA_ARGS_COMMON="${JUDGE_VLLM_EXTRA_ARGS_COMMON:---mm-processor-cache-gb 0}"
JUDGE_VLLM_EXTRA_ARGS_SMALL="${JUDGE_VLLM_EXTRA_ARGS_SMALL:---max-num-seqs 16 --max-num-batched-tokens 65536}"
JUDGE_VLLM_EXTRA_ARGS_32B="${JUDGE_VLLM_EXTRA_ARGS_32B:---max-num-seqs 8 --max-num-batched-tokens 65536}"
