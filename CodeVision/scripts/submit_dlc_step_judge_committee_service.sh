...
COMMITTEE_REQUIRED_ANY_GROUPS="${COMMITTEE_REQUIRED_ANY_GROUPS:-qwen3_vl_32b,qwen36plus_api,qwen35_397b_a17b_api}"
COMMITTEE_MAX_INFLIGHT_REQUESTS="${COMMITTEE_MAX_INFLIGHT_REQUESTS:-32}"
COMMITTEE_LOCAL_MAX_CONCURRENCY="${COMMITTEE_LOCAL_MAX_CONCURRENCY:-4}"
COMMITTEE_32B_MAX_CONCURRENCY="${COMMITTEE_32B_MAX_CONCURRENCY:-2}"
