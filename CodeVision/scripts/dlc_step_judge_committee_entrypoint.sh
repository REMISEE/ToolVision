...
JUDGE_MAX_MODEL_LEN_SMALL="${JUDGE_MAX_MODEL_LEN_SMALL:-32768}"
JUDGE_MAX_MODEL_LEN_32B="${JUDGE_MAX_MODEL_LEN_32B:-32768}"
...
COMMITTEE_MIN_SUCCESSES="${COMMITTEE_MIN_SUCCESSES:-4}"
COMMITTEE_MIN_SUCCESS_GROUPS="${COMMITTEE_MIN_SUCCESS_GROUPS:-4}"
COMMITTEE_REQUIRED_GROUPS="${COMMITTEE_REQUIRED_GROUPS:-}"
COMMITTEE_REQUIRED_ANY_GROUPS="${COMMITTEE_REQUIRED_ANY_GROUPS:-qwen3_vl_32b,qwen36plus_api}"
COMMITTEE_MAX_INFLIGHT_REQUESTS="${COMMITTEE_MAX_INFLIGHT_REQUESTS:-32}"
COMMITTEE_REQUEST_QUEUE_SIZE="${COMMITTEE_REQUEST_QUEUE_SIZE:-512}"
COMMITTEE_LOCAL_MAX_CONCURRENCY="${COMMITTEE_LOCAL_MAX_CONCURRENCY:-8}"
COMMITTEE_32B_MAX_CONCURRENCY="${COMMITTEE_32B_MAX_CONCURRENCY:-4}"
COMMITTEE_API_MAX_CONCURRENCY="${COMMITTEE_API_MAX_CONCURRENCY:-4}"
COMMITTEE_INCLUDE_8B_TEST="${COMMITTEE_INCLUDE_8B_TEST:-0}"
JUDGE_START_8B_TEST="${JUDGE_START_8B_TEST:-1}"
...
export JUDGE_PORT_2B JUDGE_PORT_4B JUDGE_PORT_8B JUDGE_PORT_32B JUDGE_PORT_8B_TEST
...
export COMMITTEE_INCLUDE_8B_TEST JUDGE_START_8B_TEST
...
if (
    os.environ.get("COMMITTEE_INCLUDE_8B_TEST", "0").lower() in {"1", "true", "yes", "on"}
    and os.environ.get("JUDGE_START_8B_TEST", "1").lower() in {"1", "true", "yes", "on"}
):
...
start_gateway() {
  ...
  export COMMITTEE_MIN_SUCCESSES
  export COMMITTEE_MIN_SUCCESS_GROUPS
...
echo "Startup: parallel=${JUDGE_PARALLEL_START}, start_8b_test=${JUDGE_START_8B_TEST}, 32b_extra_args=${JUDGE_VLLM_EXTRA_ARGS_32B:-<none>}"
...
if is_enabled "${JUDGE_START_8B_TEST}"; then
