...
# 8-GPU ArxivQA holdout eval for merged HF export of mutv1_128bs_0618/global_step_140.
...
export JOB_NAME_PREFIX="${JOB_NAME_PREFIX:-cv-mutv1-128bs-s140-merged-arxivqa-8gpu}"
export EXP_PREFIX="${EXP_PREFIX:-mutv1_128bs_s140_merged_arxivqa_8gpu}"
