#!/usr/bin/env bash
# Run mix200 SFT with the neutral sp3/v03 prompt on ChartQA and OCRBench.
...
nohup bash scripts/run_tools_eval_all_wait_5gpu_nohup.sh \
  > /mnt/cpfs/delinmao/logs/eval_mix200_sft_v03_chartqa_ocrbench_llmjudge.log 2>&1 &

echo "Started eval. Log: /mnt/cpfs/delinmao/logs/eval_mix200_sft_v03_chartqa_ocrbench_llmjudge.log"
