...
# 8-GPU eval for merged HF export of mutv1_128bs_0618/global_step_140 on the 9-benchmark set.
# One DLC job runs all datasets sequentially.

cd "${ROOT_DIR:-/mnt/cpfs/delinmao/ToolVision/CodeVision}"

export MODEL_PATH="${MODEL_PATH:-/mnt/cpfs/delinmao/ToolVision/CodeVision/saves/ToolVisionRL/merged_hf/mutv1_128bs_global_step_140}"
export RESUME_MODE="${RESUME_MODE:-disable}"
export RESUME_FROM_PATH="${RESUME_FROM_PATH:-null}"

export JOB_NAME_PREFIX="${JOB_NAME_PREFIX:-cv-mutv1-128bs-s140-merged-allbench-8gpu}"
export EXP_PREFIX="${EXP_PREFIX:-mutv1_128bs_s140_merged_allbench_8gpu}"
export GROUP1_DATASETS="${GROUP1_DATASETS:-vstar chartqa ocrbench countbench hrbench4k hrbench8k fsc147_val fsc147_test arxivqa}"
...
# Default to replica 1 from the 172.17.1.140 tool service set.
export TOOL_DLC_HOST="${TOOL_DLC_HOST:-172.17.1.140}"
export TOOL_DLC_BASE_PORT="${TOOL_DLC_BASE_PORT:-18090}"
