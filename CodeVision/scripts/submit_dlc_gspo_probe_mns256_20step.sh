...
# Probe: test whether max_num_seqs=256 remains format-safe while recovering
# more throughput than expC's conservative max_num_seqs=16 setting.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export JOB_NAME="${JOB_NAME:-codevision_gspo_probe_mns256_20step_0612}"
export EXP_NAME="${EXP_NAME:-qwen3vl8b_gspo_probe_mns256_20step_0612}"
...
echo "Submitting max_num_seqs=256 probe, 20 training steps"
