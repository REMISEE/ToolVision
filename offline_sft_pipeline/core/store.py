        ...
        return MessagesDocument.model_validate(
            [
                ...
                },
                {
                    ...
                    "metadata": {"message_kind": "user_question"},
                },
            ]
        )
    ...
    def init_child_trajectory(
        ...
        *,
        ...
        self._copy_directory_contents(
            self.planner_dir(sample_id, parent_trajectory.trajectory_id),
            self.planner_dir(sample_id, trajectory_id),
        )
        self._copy_directory_contents(
            self.steps_dir(sample_id, parent_trajectory.trajectory_id),
            self.steps_dir(sample_id, trajectory_id),
        )
        self._copy_directory_contents(
            self.judge_dir(sample_id, parent_trajectory.trajectory_id),
            self.judge_dir(sample_id, trajectory_id),
        )
