...
def build_three_round_demo_spec(
    ...
    *,
    ...
    return ThreeRoundDemoSpec(
        ...
        config=config,
        scenario_notes=[
            "Round 0 forks three child trajectories from the root.",
            "Round 1 mixes direct answer, continue-using-prior-tool, and revise-prior-tool branches.",
            "Global M=3 selection keeps s21/s31/s22 and leaves s32 unexecuted in planner history only.",
            "Round 2 mixes answered, failed, and max_step_reached terminal outcomes.",
        ],
    )
